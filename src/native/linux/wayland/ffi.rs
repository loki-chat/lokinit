...
pub type GlobalRegistryHandler =
    unsafe extern "C" fn(*mut RegistryState, *mut WlRegistry, u32, *const c_char, u32);
pub type GlobalRegistryRemover = unsafe extern "C" fn(*mut RegistryState, *mut WlRegistry, u32);

#[repr(C)]
pub struct WlRegistryListener {
    global_registry_handler: GlobalRegistryHandler,
    global_registry_remover: GlobalRegistryRemover,
}
...
library! {
    ...
    {
        wl_registry_interface: *mut WlInterface;
    }
